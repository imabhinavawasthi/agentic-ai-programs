...
# We expect the LLM to return a profile containing exactly these three fields.
# Pydantic will auto-cast types (e.g., converting string "95" to integer 95) or fail fast.
